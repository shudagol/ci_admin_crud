                    ...
                    <div class="panel-body">
                       <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <button class="btn btn-primary " onclick="add_person()" style="margin-left:550px"><i class="fa fa-table "></i>  Tambah Data</button>

                            <a href="<?php echo base_url('pegawai/import') ?>" class="btn btn-primary"><i class="fa fa-table "></i> Import Data</a>
...
window.onload = function(){
    ...
    function tampil(){
      ...
      $.get("<?php echo base_url('pegawai/data_foreach') ?>", function(msg){
        $('#tabel-body').html(msg);
...
$('#form1').submit(function(e) {
    ...
    $.ajax({
        method : 'POST',
        url: '<?php echo base_url('pegawai/act_save') ?>',
        data: pegawaiform
    })
    .done(function(msg) {
        $('.myAlert').show();
...
$(document).on("click", ".btn-edit", function() {
    ...
    $.get("<?php echo base_url(); ?>pegawai/edit/"+id, function(msg){
        // alert(msg);
        $('#m-update').html(msg);
        $('#edit').modal('show');
...
$(document).on("click", ".btn-delete", function(e) {
    ...
    if (tes) {
        var id = $(this).attr('data-id');
        $.get("<?php echo base_url(); ?>pegawai/hapus/"+id, function(){
            $('#edit').modal('hide');
            table.destroy();
            tampil();   
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Tambah hghjgjh Pegawai</h3>
            </div>
                ...
                <form id="form1" class="form-horizontal" method="POST">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nama_pegawai" placeholder="First Name" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="alamat" placeholder="Masukan Kota" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
